...
public class FindFriendsServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<String> findfriend_list = new ArrayList<>();
        ...
        findfriend_list = FriendsSearch.getAdvancedSearch(_list);

        session.setAttribute("specificfriend_list",findfriend_list);
