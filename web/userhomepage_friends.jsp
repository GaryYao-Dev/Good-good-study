...
<div class="container">
    ...
    <div class="row">
        <div class="shadow">
            <c:forEach var="u" items="${homepage_friendlist}">
                ...
                <c:if test="${u.userid != sessionScope.userid}">
                    <div class="col-sm-12">
                        ...
                        <div class="col-sm-2">
                            <br>
                            <button type="button" id ="${u.userid}" onclick="cancelrequest(${u.userid})">remove friend </button>
                        </div>
                    </div>
...
<script>
    ...
    <form id="jump" action="homepagefriends"  method="get"></form>
